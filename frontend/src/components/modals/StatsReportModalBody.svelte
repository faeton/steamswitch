<script lang="ts">
  ...
  import * as PlatformService from "../../../bindings/steamswitch/internal/platform/platformservice";
  import type { StatsReport } from "../../../bindings/steamswitch/internal/platform/models";
