...
var updaterReleaseAssets = map[string]string{
	"windows/amd64": "SteamSwitch.exe",
	// "darwin/arm64":  "SteamSwitch-macos-universal.zip",
	// "darwin/amd64":  "SteamSwitch-macos-universal.zip",
	// "linux/amd64":   "SteamSwitch-linux-amd64.tar.gz",
}
