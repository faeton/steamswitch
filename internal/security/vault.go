...
// accountBlobAAD builds the AAD for an encrypted account blob. The "tcno"
// prefix is frozen wire format from released builds; changing it would break
// decryption of existing blobs.
